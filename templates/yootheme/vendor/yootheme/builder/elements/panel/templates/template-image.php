...
if ($props['image']) {
    ...
    $image = $this->el('image', [
        ...
        'class' => [
            'el-image',
            'uk-border-{image_border}' => !$props['panel_style'] || ($props['panel_style'] && (!$props['image_card'] || $props['image_align'] == 'between')),
            ...
            'uk-margin[-{image_margin}]-top {@!image_margin: remove} {@!image_box_decoration}' => $props['image_align'] == 'between' || ($props['image_align'] == 'bottom' && !$props['image_card']),
        ],
