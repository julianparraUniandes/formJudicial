    ...
    'events' => [
        ...
        'theme.admin' => function ($theme) {
            ...
            $this->customizer->addData('menu', [
                ...
                'canDelete' => $this->user->authorise('core.edit.state', 'com_menus'),
                'canEdit' => $this->user->authorise('core.edit', 'com_menus'),
                'canCreate' => $this->user->authorise('core.create', 'com_menus'),
            ]);
        },
