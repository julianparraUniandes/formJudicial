...
- Add more margin options for fields in all elements
- Add color option for inlined SVGs in elements
...
- Add stroke animation option for inline SVG in Grid, List, Switcher and Table elements
