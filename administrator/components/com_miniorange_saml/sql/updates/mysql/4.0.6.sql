...
INSERT IGNORE INTO `#__miniorange_saml_customer_details`(`id`,`login_status`) values (1,false) ;

INSERT IGNORE INTO`#__miniorange_saml_config`(`id`,`enable_email`,`username`,`email`,`name`) values (1,false,'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name','http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name','http://schemas.microsoft.com/identity/claims/displayname');
